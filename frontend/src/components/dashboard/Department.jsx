...
const Department = () => {
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`http://localhost:4000/api/auth/delete-department/${id}`)
      .then((response) => {
  ...
  const handleSaveEdit = () => {
    axios.put(`http://localhost:4000/api/auth/edit-department/${editDepartmentId}`, editDepartmentData)
      .then((response) => {
        if (response.data.success) {
